...
async function submit() {
    ...
    error.value = ''
    try {
        // 닉네임을 이메일 대신 전달 (백엔드에서 이메일이 필수면 임시 이메일 생성)
        const tempEmail = `${form.value.username}@moviemate.temp`
        await store.signup(form.value.username, form.value.password, tempEmail)
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">MovieMate와 함께 시작하세요</p>
            </div>
